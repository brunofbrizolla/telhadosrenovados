        ...
        <div class="hero-layout">
            ...
            <div class="hero-form-column">
                <div class="hero-form-box">
                    ...
                    <form id="heroForm" action="https://script.google.com/macros/s/AKfycbzoXrP83HEHZbRxN_tYjFHiBfUPahjcUdFc_IqbJMUdtxJlOWHuMz-GxOTZNbOKKolg/exec" target="hero_iframe" method="POST" onsubmit="heroSubmitted=true;">
                        <div class="form-row">
    ...
    <div class="container">
        <div class="form-inner">
            ...
            <div class="orcamento-form">
                ...
                <form id="contactForm" action="https://script.google.com/macros/s/AKfycbzoXrP83HEHZbRxN_tYjFHiBfUPahjcUdFc_IqbJMUdtxJlOWHuMz-GxOTZNbOKKolg/exec" target="hidden_iframe" method="POST" onsubmit="submitted=true;">
                    <div class="form-row">
