        ...
        <div class="hero-layout">
            ...
            <div class="hero-form-column">
                <div class="hero-form-box">
                    ...
                    <iframe name="hero_iframe" id="hero_iframe" style="display:none;" onload="if(heroSubmitted){window.location.href='/obrigado.html';}"></iframe>
                    <form id="heroForm" action="https://script.google.com/macros/s/AKfycbzHoD7XIEEaQQvsG2r66O2gMGOotON0zt8l_ZpuksC997OjfFDXxHrc-s8SAYGtqZ7U/exec" target="hero_iframe" method="POST" onsubmit="heroSubmitted=true;">
                        <div class="form-row">
                        ...
                        <div class="form-row">
                            <label>Sua Mensagem / Detalhes</label>
                            <textarea name="detalhes" placeholder="Explique brevemente o que precisa..." rows="2"></textarea>
                        </div>
    ...
    <div class="container">
        <div class="form-inner">
            ...
            <div class="orcamento-form">
                ...
                <iframe name="hidden_iframe" id="hidden_iframe" style="display:none;" onload="if(submitted){window.location.href='/obrigado.html';}"></iframe>
                <form id="contactForm" action="https://script.google.com/macros/s/AKfycbzHoD7XIEEaQQvsG2r66O2gMGOotON0zt8l_ZpuksC997OjfFDXxHrc-s8SAYGtqZ7U/exec" target="hidden_iframe" method="POST" onsubmit="submitted=true;">
                    <div class="form-row">
        ...
        <div class="footer-inner">
            ...
            <div>
                ...
                <ul>
                    ...
                    <li><a href="mailto:telhadosrenovados@outlook.pt">telhadosrenovados@outlook.pt</a></li>
